...
-- 蒸馏药剂反伤  -- 伤害
TUNING.GHOSTLYELIXIR_RETALIATION_DAMAGE = 27
...
TUNING.GHOSTLYELIXIR_PLAYER_RETALIATION_DAMAGE = 60*5 -- 5分钟  -- 复仇药剂
TUNING.GHOSTLYELIXIR_PLAYER_LIGHT_DURATION  = 60*5 -- 5分钟  -- 荧光药剂

-- 对于阿比
TUNING.GHOSTLYELIXIR_LIGHT_DURATION         = 60*6 -- 6分钟  -- 荧光药剂
TUNING.SKILLS.WENDY.LUNARELIXIR_DURATION    = 60*6 -- 6分钟  -- 光之怒药剂
TUNING.SKILLS.WENDY.SHADOWELIXIR_DURATION   = 60*6 -- 6分钟  -- 诅咒之苦药剂
